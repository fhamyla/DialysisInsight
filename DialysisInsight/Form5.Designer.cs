namespace DialysisInsight
{
    partial class Calendar
    {
        ...
        private void InitializeComponent()
        {
            ...
            // daycontainer
            // 
            daycontainer.ColumnCount = 1;
            daycontainer.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            daycontainer.Location = new Point(19, 103);
            daycontainer.Name = "daycontainer";
            daycontainer.RowCount = 1;
            daycontainer.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
